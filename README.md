# Graficación
**Rosa Abigail Flores Florentino**  

## Contenido del repositorio

- **Sesion4** — Animación y control de tiempo
  - `sesion4_ej1.py`: Rebote con velocidad variable
  - `sesion4_ej2.py`: Animación de pulsación
  - `sesion4_ej3.py`: Simulación de gravedad

- **Sesion5** — Imágenes y sprites
  - `sesion5_ej1.py`: Ajuste de tamaño dinámico
  - `sesion5_ej2.py`: Sprite animado
  - `sesion5_mini.py`: Nave que rota y se mueve
  - Recursos: `logo-itnca-orig.png`

- **Sesion6** — Colisiones y aplicaciones prácticas
